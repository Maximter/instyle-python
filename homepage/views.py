...
def index(request):
    ...
    #     friends += (f'<input type="radio" name="friend" required value="{friend}">{friend}<br>')
    ...
    #     ice_form = f'<input type="radio" name="icecream" required value="{icecream_db[i]["name"]}">{icecream_db[i]["name"]}<br>'
